...
class Wp_Utilities_Admin {
    ...
    public function registersettings() {
        ...
        register_setting( 'wp-utilities', 'wp_utilities_remove_versions');
        ...
        register_setting( 'wp-utilities', 'wp_utilities_delay_scripts_and_styles');
        register_setting( 'wp-utilities', 'wp_utilities_delay_scripts_and_styles_autoload_delay');
        register_setting( 'wp-utilities', 'wp_utilities_preload_images');
    }
